...
})(self, function(__WEBPACK_EXTERNAL_MODULE__678__, __WEBPACK_EXTERNAL_MODULE__547__) {
...
var _events = __webpack_require__(521);
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__547__;
...
class Resources {
  ...
  createCssFile(href) {
    ...
    return textResponse.then(text => {
      ...
      text = substitute(text, relUrls, this.replacementUrls); // Get the new url
...
class Contents {
  ...
  textWidth() {
    ...
    let border = borders(content); // Select the contents of frame
...
var marks = __webpack_require__(476);
...
class IframeView {
  ...
  highlight(cfiRange, data = {}, cb, className = "epubjs-hl", styles = {}) {
    ...
    let m = new marks/* Highlight */.y$(range, className, data, attributes);
  ...
  underline(cfiRange, data = {}, cb, className = "epubjs-ul", styles = {}) {
    ...
    let m = new marks/* Underline */.v6(range, className, data, attributes);
    let h = this.pane.addMark(m);
...
class ContinuousViewManager extends managers_default {
  constructor(options) {
    ...
    extend(this.settings, options.settings || {}); // Gap can be 0, but defaults doesn't handle that
...
var external_jszip_ = __webpack_require__(547);
...
class Book {
  ...
  store(name) {
    ...
    this.storage = new store(name, requester, this.resolve.bind(this)); // Replace request method to go through store
    ...
    this.opened.then(() => {
      ...
      this.storage.on("offline", () => {
        ...
        this.url = new utils_url("/", ""); // Add hook to replace resources in contents
