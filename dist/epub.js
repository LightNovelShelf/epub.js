...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_75__) {
...
function parse(markup, mime, forceXMLDom) {
	...
	if (typeof DOMParser === "undefined" || forceXMLDom) {
		Parser = __webpack_require__(18).DOMParser;
	} else {
		Parser = DOMParser;
	}
...
var _themes = __webpack_require__(55);
...
var _annotations = __webpack_require__(56);
...
var _marksPane = __webpack_require__(57);
...
var _snap = __webpack_require__(73);
...
var _urlPolyfill = __webpack_require__(79);
...
var _archive = __webpack_require__(74);
...
var _displayoptions = __webpack_require__(78);
		...
		value: function render(_request) {
			...
			this.load(_request).then(function (contents) {
				...
				if (typeof XMLSerializer === "undefined" || isIE) {
					Serializer = __webpack_require__(18).DOMParser;
				} else {
...
var baseTrim = __webpack_require__(65),
    isObject = __webpack_require__(16),
		...
		value: function checkRequirements() {
			try {
				if (typeof JSZip === "undefined") {
					var _JSZip = __webpack_require__(75);
					this.zip = new _JSZip();
				} else {
					this.zip = new JSZip();
				}
...
if(typeof __WEBPACK_EXTERNAL_MODULE_75__ === 'undefined') {var e = new Error("Cannot find module \"jszip\""); e.code = 'MODULE_NOT_FOUND'; throw e;}
